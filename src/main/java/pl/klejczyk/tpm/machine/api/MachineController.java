...
class MachineController {
    ...
    @PostMapping
    ResponseEntity<MachineResponse> register(@Valid @RequestBody RegisterMachineRequest request) {
        MachineResponse response = MachineResponse.from(service.register(request.name()));
